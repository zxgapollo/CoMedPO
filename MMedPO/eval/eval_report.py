...
if __name__ == "__main__":
    ...
    for result in results:
        table_data.append([
            ...
            f"{result['bleu_score_1']:.2f}",
            f"{result['bleu_score_2']:.2f}",
            f"{result['bleu_score_3']:.2f}",
            f"{result['bleu_score_4']:.2f}",
            f"{result['rouge_l']:.2f}",
            f"{result['meteor']:.2f}",
        ])

    headers = ["File Name", "Exact Match", "F1 Score", "Precision", "Recall", "BLEU Score", "BLEU Score 1", "BLEU Score 2", "BLEU Score 3", "BLEU Score 4", "ROUGE-L", "METEOR"]

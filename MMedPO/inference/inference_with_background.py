    ...
    for line in tqdm(dataloader, position=0, file=sys.stdout):
        ...
        if args.output_image_folder and rank == 0:
            try:
                ...
                output_filename = f"{base_name}_stitched_with_mask.jpg"
...
def main():
    ...
    parser.add_argument("--output-image-folder", type=str, default=None, help="Optional: Path to save composed images for with-background runs.")

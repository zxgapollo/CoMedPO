...
class DPOTrainer(Trainer):
    ...
    def dpo_loss(
        ...
        """
        # Apply length normalization to reduce bias from length differences
        # This helps address the issue where chosen responses are much shorter than rejected ones
        ...
        # Improved reward calculation with better scaling
    ...
    def _get_batch_logps(
        ...
        average_log_prob: bool = True,  # Changed default to True for length normalization
    ) -> torch.FloatTensor:
    ...
    def concatenated_forward(
        ...
        chosen_logps = self._get_batch_logps(
            chosen_logits,
            new_chosen_labels,
            average_log_prob=True,  # Enable length normalization
        )

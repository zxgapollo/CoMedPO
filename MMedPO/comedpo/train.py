...
def parse_args():
    ...
    parser.add_argument("--beta", type=float, default=0.1, help="Preference-loss scale eta^{-1}")
    parser.add_argument("--causal-weight", type=float, default=1.0)
    parser.add_argument("--noise-std", type=float, default=0.1, help="Additive noise std in [0,1] pixel units")

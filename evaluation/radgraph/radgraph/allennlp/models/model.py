...
from radgraph.allennlp.data import Instance, Vocabulary
from radgraph.allennlp.data.batch import Batch
from radgraph.allennlp.nn import util
from radgraph.allennlp.nn.regularizers import RegularizerApplicator
...
class Model(torch.nn.Module, Registrable):
    ...
    def from_archive(cls, archive_file: str, vocab: Vocabulary = None) -> "Model":
        ...
        """
        from radgraph.allennlp.models.archival import load_archive  # here to avoid circular imports

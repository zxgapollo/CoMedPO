...
from radgraph.allennlp.common.util import namespace_match

if TYPE_CHECKING:
    from radgraph.allennlp.data import instance as adi  # noqa
...
def _read_pretrained_tokens(embeddings_file_uri: str) -> List[str]:
    ...
    from radgraph.allennlp.modules.token_embedders.embedding import EmbeddingsTextFile

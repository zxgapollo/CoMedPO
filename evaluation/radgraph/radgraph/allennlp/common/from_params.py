...
from radgraph.allennlp.common.lazy import Lazy
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from radgraph.allennlp.common.registrable import Registrable  # import here to avoid circular imports
...
def pop_and_construct_arg(
    ...
    """
    from radgraph.allennlp.models.archival import load_archive  # import here to avoid circular imports

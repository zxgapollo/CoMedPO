...
import torch
from radgraph.allennlp.data.samplers import SequentialSampler

from radgraph.allennlp_models.structured_prediction.models.srl import write_to_conll_eval_file
...
from radgraph.allennlp.data import DatasetReader, DataLoader
from radgraph.allennlp.nn.util import move_to_device
